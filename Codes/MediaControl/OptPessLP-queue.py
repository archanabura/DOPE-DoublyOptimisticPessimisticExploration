...
# -*- coding: utf-8 -*-
"""
Created on Mon Dec  6 12:42:08 2021
...
L = math.log(32 * N_STATES**2 * EPISODE_LENGTH * NUMBER_EPISODES / DELTA)#math.log(2 * N_STATES * EPISODE_LENGTH * NUMBER_EPISODES * N_STATES**2 / DELTA)
...
for sim in range(NUMBER_SIMULATIONS):
    ...
    for episode in range(NUMBER_EPISODES):
        ...
        if cost_b[0,0] >= (CONSTRAINT+Cb)/2:
                pi_k = pi_b
                q_k, value_k, cost_k = util_methods.FiniteHorizon_Policy_evaluation(util_methods.P,pi_b,util_methods.R,util_methods.C)
        ...
        if episode != 0 and episode%50000== 0:
            ...
            filename = 'Tao-queue' + str(RUN_NUMBER) + '.pckl'
            f = open(filename, 'ab')
